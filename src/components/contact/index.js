        ...
        <Fragment>
            ...
            <ReactBootStrap.Row>
                ...
                <div class="form-group">
                    ...
                    <input style={{background: 'none', color: 'white', width: '60%', height: '50px'}} class="form-control" name="Name" id="name" type="text" required />
                </div>
                        <input type="hidden" name="_captcha" value="false"></input>
                        <div style={{marginTop: '7%'}}>
                    <label  style={{color: 'white'}}>Email*</label>
                    <input name="Email" id="email" type="email" style={{background: 'none', width: '60%', height: '50px'}} class="form-control" required/>
                </div>
                        <div style={{marginTop: '5%'}} >
                        <div class="form-group">
                <label style={{color: 'white'}}>Message*</label>
                <textarea class="form-control" style={{background: 'none', width: '60%'}} id="exampleFormControlTextarea1" rows="9"></textarea>
            </div>
