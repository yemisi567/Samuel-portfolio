...
import { Name, Container, Text,  StyledDot, Title, SubText, StyledFlowChart, StyledCaseButton } from './style';
        ...
        <Fragment>
           ...
           <Text>A platfrom to save/contribute money as a group <br />
                ...
                <ReactBootStrap.Row className="justify-content-md-center" style={{padding: '10% 10%', marginLeft: '5%'}}>
                    ...
                    <ReactBootStrap.Col xs lg="2" sm='2'>
                    <ReactBootStrap.Button style={{ border: 'none' , backgroundColor: 'rgba(9, 207, 131, 1)' ,color: 'white', marginLeft: '5%', fontWeight: '600', padding: '8% 20%', fontSize: '24px'}}>Mobile</ReactBootStrap.Button>
                    </ReactBootStrap.Col>
                </ReactBootStrap.Row>
           </Container>
                ...
                <ReactBootStrap.Row>
                 ...
                 <FooterContainer >
                     ...
                     <FooterWrapper style={{backgroundColor: 'white', width: '100%'}} >
                           <div className='padding' style={{paddingBottom: '6%'}}>
                           <div className='first'><strong>The Challange</strong></div>
                               <ReactBootStrap.Row>
                                   <ReactBootStrap.Col sm={7}>
                               <div className='challange'>
                               A lot of Nigerians understand one cliche, which is "saving for the rainy day, <br />" an
                                                 expression used to  convey  how important it is to save. It's surprising to  <br />find that 
                                                 Nigerians do not save as much as believed. According to the <br />International Monetary  Fund, the
                                                  gross saving rate in Nigeria  stands at 15%, <br />far below China at 49%, and even  below otherAfrican countries.
                                               <br />
                                               <br />
                                                While growing up, I saw a lot of government workers in Nigeria trying to save with<br /> friends at work but ended up 
                                                having issues when they were expected to collect their <br />money from the person/individual holding the money.
                               </div>
                                   </ReactBootStrap.Col>
                                   <ReactBootStrap.Col sm={5}>
                                  <img src={Flag} alt='' width='86%' height='86%' />
                                       </ReactBootStrap.Col>
                           ...
                           <strong className='title'> What I did</strong>
                            ...
                            <div>
                                       <ReactBootStrap.Row style={{marginTop: '4%'}}>
                                               ...
                                               Design a platform that allows users to save as an <br />individual or 
                                                 as a group thereby allowing them to be <br />paid automatically by the system.
                                               </div>
                 ...
                 <div className='scope' style={{paddingTop:'5%', paddingLeft: '5%'}}> <StyledDot src={Dot}/><span style={{color: '#D3D3D3'}}>Who am i designing for?</span></div>
                  <div className='padding'>
                ...
                <ReactBootStrap.Row>
                 ...
                 <div className='scope' style={{paddingTop: '5%', paddingLeft: '5%'}}>Sitemap- Wireframe - High fidelity</div>
                   ...
                   <div className='scope' style={{paddingTop: '5%', paddingBottom: '3%'}}>
                    <div style={{color: '#D3D3D3', marginLeft: '3%'}}> <strong>.</strong> Site Map</div>
                    </div>
                    
                <ReactBootStrap.Row>
                     <ReactBootStrap.Col style={{marginLeft: '3%'}}>
                 ...
                 <ReactBootStrap.Row>
                     <ReactBootStrap.Col style={{marginLeft: '6%'}}>
                 ...
                 <div className='scope' style={{paddingTop: '5%', paddingBottom: '2%'}}>
                      <StyledDot src={Dot}/> <span style={{color: '#D3D3D3'}}>High Fidelity</span>
                      </div>
                 <ReactBootStrap.Row>
                     <ReactBootStrap.Col style={{marginLeft: '5%'}}>
                    <div className='wireframe'>
