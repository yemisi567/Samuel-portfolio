        ...
        return (
         <Fragment>
                  <Container>
                        ...
                        style={{color: 'black', backgroundColor: '#C4C4C4', border: 'none', width: '205px', height: '67px'}}>
                   ...
                   <GoalsText>
                            <ReactBootStrap.Row>
                                    <ReactBootStrap.Col>
                                    Reduce the total number of steps<br/> to perform a transaction on ATM.
                                    </ReactBootStrap.Col>
                                    <ReactBootStrap.Col>
                                    Help Local banks to serve <br/>their customers much better.
                                    </ReactBootStrap.Col>
                                    <ReactBootStrap.Col>
                                    Make cash withdrawal in Africa <br/>seamless for customers /users.
                                    </ReactBootStrap.Col>
                            </ReactBootStrap.Row>
                    </GoalsText>
                   </StyledAnimation>
                   ...
                   <GoalsText>
                    <ReactBootStrap.Row>
                                ...
                                <InnerText>Empathize</InnerText>
                                    ...
                                    <ReactBootStrap.Col sm={8} style={{paddingLeft: '10%', marginTop: '7%'}} >
                ...
                <GoalsText>
                    <ReactBootStrap.Row>
                                    ...
                                    <img src={Line} alt='' style={{marginLeft: '-15%'}}/>
                                    </QuestionsText>
                      ...
                      <ReactBootStrap.Row>
                        <ReactBootStrap.Col>
                                ...
                                <InnerText>Design</InnerText>
                                    ...
                                    <span style={{float: 'right', marginRight: '6%', fontSize: '48px'}}>User persona</span>
                                    </div>
                                    </ReactBootStrap.Col> 
                            </ReactBootStrap.Row>
                    </GoalsText>
                      ...
                      <ReactBootStrap.Row>
                        <ReactBootStrap.Col>
                                ...
                                <InnerText>Ideate</InnerText>
                                    ...
                                    <ReactBootStrap.Col  style={{color: '#FDAE24', marginTop: '7%'}} >
                                     <span style={{float: 'right', marginRight: '13%', fontSize: '48px'}}>Low Fidelity</span>
                                    </ReactBootStrap.Col> 
                            </ReactBootStrap.Row>
                    </GoalsText>
                    <GoalsText>
                       ...
                       Mid Fidelity
                        ...
                        <img src={FaintLine} alt='' style={{marginLeft: '10%', width: '30%'}} />
                           ...
                           <ReactBootStrap.Row>
                                   <ReactBootStrap.Col>
                               <StyledImage>
                               <img src={HighFidelity} alt='' style={{marginLeft: '10%', marginTop: '15%' ,width: '80%'}}/>
                               </StyledImage>
                                   </ReactBootStrap.Col>
                                   <ReactBootStrap.Col>
                                   <QuestionsText>
                                  ...
                                  <div style={{marginTop: '-4%'}}>Home Screen</div>
                                  </QuestionsText>
                                           <StyledAnimation3>
                          ...
                          <ReactBootStrap.Row>
                           ...
                           <ReactBootStrap.Row>
                                   <ReactBootStrap.Col>
                                   <StyledAnimation>
                                   <div style={{padding: '1% 0% 0% 20%', color: 'white'}}>
