              ...
              <FooterContainer >
                     <FooterWrapper style={{width: '100%', paddingBottom: '4%'}}>
                                    ...
                                    <ReactBootStrap.Card.Body >
                                        ...
                                        <ReactBootStrap.Row>
                                                <ReactBootStrap.Col style={{color: '#D3D3D3'}}>
                                            ...
                                            <ReactBootStrap.Row>
                                                <ReactBootStrap.Col style={{color: '#D3D3D3', paddingTop: '7%'}}>
                    ...
                    <FooterWrapper style={{backgroundColor: 'white', width: '100%', marginTop: '5%'}} >
                           <div className='padding' style={{paddingBottom: '10%'}}>
                           <div className='first'><strong>The Challange</strong></div>
                               <ReactBootStrap.Row>
                                   <ReactBootStrap.Col >
                               <div className='challange'>
                               Paying vital payments has become a part of our daily lives.In Nigeria, it appears that a larger
                                                    proportion of the population pays for airtime, data, or cable on a daily basis. 
                                                    Most people find the procedure of making payments difficult since they must either go to their bank or use a POS. 
                                                    <br /> 
                                                    <br /> 
                                                    ...
                                                    <br /> 
                                                    <br /> 
                                                    Note: PayMyBills is a BOT solution, and the stakeholders made the decision to also design a web 
                                                    platform to allow users to perform the same transaction and also add more features.
                               </div>
                                   </ReactBootStrap.Col>
                                   <ReactBootStrap.Col >
                 ...
                 <div className='scope' style={{paddingBottom: '2%'}}> <StyledDot src={Dot}/><span style={{color: '#D3D3D3', }}>Who am i designing for?</span></div>
                    <div className='padding'>
                    <StyledAnimation2>
                ...
                <div className='scope' style={{paddingTop: '5%', paddingLeft: '5%'}}>Brainstorming - User Flow</div>
                 ...
                 <div className='scope' style={{paddingTop: '5%'}}>Sitemap- Wireframe - High fidelity</div>
                   <Title>Prototyping deliverables</Title>
                   <div className='scope' style={{ paddingBottom: '3%'}}>
                      <StyledDot src={Dot}/> <span style={{color: '#D3D3D3'}}>Site Map</span></div>
                 <ReactBootStrap.Row>
                     <ReactBootStrap.Col >
                    <StyledAnimation>
                 ...
                 <ReactBootStrap.Row>
                     ...
                     <Title style={{marginLeft: '10%'}}>User Testing</Title>
                   <StyledAnimation>
                   <div className='about-martins' style={{marginLeft: "11%"}}>
                    ...
                    <StyledAnimation>
                    <div className='about-martins'> <strong>.</strong> <span style={{color: '#D3D3D3' }}>Key Findings</span></div>
                         <div className='about-martins'>
