    ...
    return (
        ...
        @theartisanbutchery</div> 
         ...
         <ReactBootStrap.Row style={{marginTop: '10%'}}>
          ...
          <StyledAnimation>
          <div style={{color: '#D3D3D3', marginLeft: '5%', marginTop: '2%', lineHeight: '46.57px', fontSize: '18px'}}>
          ...
          <SemiHeading style={{marginTop: '4%'}}>  <strong>.</strong> Deliverables</SemiHeading>
                                       ...
                                       <ReactBootStrap.Row>
                                            ...
                                            <br/>
                                            3 . Items include business card, Letterhead, Nylon,T-shirt, <br />Package page etc. 
                                            </Text>
                                                ...
                                                ><strong>.</strong> Duration</span>
                                                    <br />
                                                    <br />
                                                    <div style={{marginLeft: '3%'}}> Aug - Oct, 2021</div>
           ...
           <a href="https://bit.ly/3GAVlxO" style={{color: 'white', textDecoration: 'none'}}>https://bit.ly/3GAVlxO</a>
            <br />
           <div style={{marginTop: '4%'}}> <a href="https://bit.ly/3K9Q6XY" style={{color: 'white', textDecoration: 'none'}}>https://bit.ly/3K9Q6XY</a></div>
            <br />
          <div style={{marginTop: '3%'}}><a href="https://bit.ly/3FmIVYM" style={{color: 'white', textDecoration: 'none'}}>https://bit.ly/3FmIVYM</a></div>
            <br />
           <div style={{marginTop: '3%'}}><a href="https://bit.ly/3K858gO" style={{color: 'white', textDecoration: 'none'}}>https://bit.ly/3K858gO</a></div>
            </LinkText>
            <FooterContainer>
                            <FooterWrapper>
                                <FooterTitle>
